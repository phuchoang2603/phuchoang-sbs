...
So if you want to start exploring and build an infrastructure like the one I'm currently hosting, here's the guide for you to do so. This is the first part of the series **`On-Premise 101: The Hardware, Networking, and More`**. In this part, I'll share my whole journey from the beginning: how I acquired the hardware, the decisions I made, and finally, how I wired it all together with networking to get it ready for the software.

## The Beginning: My First SFF Server and Its (Many) Limits
